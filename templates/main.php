<section class="promo">
    ...
    <ul class="promo__list">
        ...
        <li class="promo__item promo__item--boards">
            <a class="promo__link" href="pages/all-lots.html"><?=check_data($value);?></a>
        </li>
        <?php endforeach; ?>
    </ul>
</section>
<section class="lots">
    ...
    <ul class="lots__list">
        ...
        <li class="lots__item lot">
            ...
            <div class="lot__info">
                <span class="lot__category"><?=check_data($val['lot_category'] ?? "");?></span>
                <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?=check_data($val['lot_name'] ?? "");?></a></h3>
